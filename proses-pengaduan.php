...
$tel_pengaduan  = $_POST['tel_pengaduan'];
$nik            = $_SESSION["nik"];
...
if (move_uploaded_file($lokasi_foto, "foto/" . $nama_foto)) {
    $sql = "INSERT INTO pengaduan (tgl_pengaduan, tel_pengaduan, nik, isi_laporan, foto, status) 
    VALUES ('$tgl_pengaduan', '$tel_pengaduan', '$nik', '$isi_laporan', '$nama_foto', '$status')";

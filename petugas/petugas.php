    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="masyarakat.php">
        <div class="sidebar-brand-icon rotate-n-15">
          <img src="img/LaporAsrama.png" alt="Icon" style="max-height: 50px; max-width: 100%; display: block; margin: auto;">
        </div>
        <div class="sidebar-brand-text mx-3">LaporAspirasi</div>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Jeppp</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
